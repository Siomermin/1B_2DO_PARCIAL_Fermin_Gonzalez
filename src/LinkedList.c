 ...
 */
int ll_indexOf(LinkedList* this, void* pElement) // APROBADO
{
    int returnAux = -1;
    int i;
    void* pAuxElement;
 ...
 *
 */
int ll_isEmpty(LinkedList* this) // APROBADO
{
    int returnAux = -1;
 ...
 */
int ll_push(LinkedList* this, int index, void* pElement) // APROBADO
{
    int returnAux = -1;
...
retorna el elemento.
 */
void* ll_pop(LinkedList* this,int index) // APROBADO
{
    void* returnAux = NULL;
 ...
 */
int ll_contains(LinkedList* this, void* pElement) // APROBADO
{
    int returnAux = -1;
...
int ll_containsAll(LinkedList* this,LinkedList* this2) // APROBADO
{
    int returnAux = -1;
    void* pElement;
    int i;
...
array.
 */
LinkedList* ll_subList(LinkedList* this,int from,int to) // APROBADO
{
...
nuevo array
 */
LinkedList* ll_clone(LinkedList* this) // APROBADO
{
    LinkedList* cloneArray = NULL;
 ...
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
 */
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order) // APROBADO
{
	int returnAux = -1;
	int i;
	int j;
...
/// \brief Filtra a los elementos de la lista utilizando la funcion criterio recibida por parametro.
/// \param this LinkedList* Puntero a la lista
/// \param pFunc (*pFunc) Puntero a la funcion criterio
/// \return int Retorna (-1) Error: si el puntero a la listas es NULL o ( 0) Si ok
